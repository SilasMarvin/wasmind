...
//                 content: hive::llm_client::ChatMessage::Assistant { tool_calls: Some(calls), .. },
//                 ..
//             } => {
...
//                 }
//             }
//             Message::AssistantToolCall(tc) => match tc.function.name.as_str() {
//                 READ_FILE_TOOL => {
//                     assert!(
//                         seen_assistant_response_1,
//                         "Read tool call must come after AssistantResponse 1"
//                     );
//                     assert_eq!(tc.id, "read_call");
...
//                     );
//                     assert_eq!(tc.id, "edit_call");
//                     seen_edit_tool_call = true;
//                 }
//                 _ => panic!("Unexpected tool call: {}", tc.function.name),
//             },
