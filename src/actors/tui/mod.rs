...
//                                 let _ = tx.send(Message::UserContext(UserContext(UserTUIInput(input)));
//                             }
//                         }
//                         KeyCode::Char(c) => {
...
//                                 if c == 'y' || c == 'Y' {
//                                     let _ = tx.send(Message::UserContext(UserContext::UserTUIInput("y".to_string())));
//                                 } else if c == 'n' || c == 'N' {
//                                     let _ = tx.send(Message::UserContext(UserContext(UserTUIInput("n".to_string()))));
//                                 }
