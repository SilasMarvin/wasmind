...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:file-interaction-with-approval:actor@0.1.0:actor-world:encoded world"
)]
#[doc(hidden)]
...
method]actor.destructor\x01\x0a\x04\0\x16hive:actor/actor@0.1.0\x05\x05\x04\06fi\
le-interaction-with-approval:actor/actor-world@0.1.0\x04\0\x0b\x11\x01\0\x0bacto\
