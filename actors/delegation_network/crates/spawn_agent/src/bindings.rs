...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:wasmind:spawn-agent@0.1.0:spawn-agent:encoded world"
)]
#[doc(hidden)]
...
\0\x19wasmind:actor/actor@0.1.0\x05\x08\x04\0%wasmind:spawn-agent/spawn-agent@0.\
1.0\x04\0\x0b\x11\x01\0\x0bspawn-agent\x03\0\0\0G\x09producers\x01\x0cprocessed-\
