...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_send_message_impl {
    ($ty:ident) => {
...
#[doc(inline)]
pub(crate) use __export_send_message_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:wasmind:send-message@0.1.0:send-message:encoded world"
)]
#[doc(hidden)]
...
\0\x19wasmind:actor/actor@0.1.0\x05\x08\x04\0'wasmind:send-message/send-message@\
0.1.0\x04\0\x0b\x12\x01\0\x0csend-message\x03\0\0\0G\x09producers\x01\x0cprocess\
