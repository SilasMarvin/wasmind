...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:hive:complete@0.1.0:complete:encoded world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 1874] = *b"\
...
[method]actor.destructor\x01\x08\x04\0\x16hive:actor/actor@0.1.0\x05\x06\x04\0\x1c\
hive:complete/complete@0.1.0\x04\0\x0b\x0e\x01\0\x08complete\x03\0\0\0G\x09produ\
