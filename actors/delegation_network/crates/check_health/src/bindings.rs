...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:hive:check-health@0.1.0:check-health:encoded world"
)]
#[doc(hidden)]
...
ive:check-health/check-health@0.1.0\x04\0\x0b\x12\x01\0\x0ccheck-health\x03\0\0\0\
