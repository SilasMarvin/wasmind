...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:hive:worker@0.1.0:worker:encoded world"
)]
#[doc(hidden)]
...
r.destructor\x01\x08\x04\0\x16hive:actor/actor@0.1.0\x05\x05\x04\0\x18hive:worke\
r/worker@0.1.0\x04\0\x0b\x0c\x01\0\x06worker\x03\0\0\0G\x09producers\x01\x0cproc\
