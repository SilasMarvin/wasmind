...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:hive:report-normal@0.1.0:report-normal:encoded world"
)]
#[doc(hidden)]
...
ive:actor/actor@0.1.0\x05\x08\x04\0&hive:report-normal/report-normal@0.1.0\x04\0\
\x0b\x13\x01\0\x0dreport-normal\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0d\
