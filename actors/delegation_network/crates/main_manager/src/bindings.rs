...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_main_manager_impl {
    ($ty:ident) => {
...
#[doc(inline)]
pub(crate) use __export_main_manager_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:hive:main-manager@0.1.0:main-manager:encoded world"
)]
#[doc(hidden)]
...
r.destructor\x01\x08\x04\0\x16hive:actor/actor@0.1.0\x05\x05\x04\0$hive:main-man\
ager/main-manager@0.1.0\x04\0\x0b\x12\x01\0\x0cmain-manager\x03\0\0\0G\x09produc\
