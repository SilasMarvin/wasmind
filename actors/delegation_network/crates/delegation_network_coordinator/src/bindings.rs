...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:hive:delegation-network-coordinator@0.1.0:delegation-network-coordinator:encoded world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 1940] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xff\x0d\x01A\x02\x01\
...
[method]actor.destructor\x01\x08\x04\0\x16hive:actor/actor@0.1.0\x05\x06\x04\0Hh\
ive:delegation-network-coordinator/delegation-network-coordinator@0.1.0\x04\0\x0b\
$\x01\0\x1edelegation-network-coordinator\x03\0\0\0G\x09producers\x01\x0cprocess\
