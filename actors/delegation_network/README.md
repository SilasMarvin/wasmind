...
The network uses Wasmind's message broadcasting system to enable seamless coordination:
...
source = { url = "https://github.com/SilasMarvin/Wasmind", package = "actors/delegation_network/crates/delegation_network_coordinator" }
...
The delegation network coordinator's [Wasmind.toml](crates/delegation_network_coordinator/Wasmind.toml) contains comprehensive default system prompts for each assistant type, including:
...
For more information about Wasmind configuration options, see the [Configuration README](../../crates/Wasmind_config/README.md).
...
The delegation network leverages Wasmind's message passing system for coordination:
...
### Hierarchy Management
- Wasmind's scope system naturally tracks parent-child relationships
